...
######## merge data ######
result_fpc_k=data.frame(rbind(data1,data2,data3,data4,data5,data6,data7,data8,data9,data10,data11,data12))
write.table(result_fpc_k,file="result_fpc_k.txt") 
